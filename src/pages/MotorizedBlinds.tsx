    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-ocean to-ocean/90 text-white py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            to="/consultation"
            className="inline-block bg-white text-ocean px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-100 active:bg-gray-200 transition-all shadow-lg"
          >
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-warm-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-warm-dark mb-8 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Zap className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">Convenience That Actually Matters</h3>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Lock className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">Energy Efficiency Built In</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Home className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">It's a Lifestyle Upgrade</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Volume2 className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">Comfort You Control Every Day</h3>
              <p className="text-gray-700 leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-ocean">
              <h3 className="text-xl font-bold text-warm-dark mb-3">The Basics</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div>
              <h3 className="text-2xl font-bold text-warm-dark mb-6">Your Control Options</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 bg-white border border-gray-200 rounded-lg">
                  <h4 className="text-lg font-semibold text-ocean mb-3">Remote Control</h4>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div className="p-6 bg-white border border-gray-200 rounded-lg">
                  <h4 className="text-lg font-semibold text-ocean mb-3">Smartphone App</h4>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div className="p-6 bg-white border border-gray-200 rounded-lg">
                  <h4 className="text-lg font-semibold text-ocean mb-3">Voice Commands</h4>
                  <p className="text-gray-700 leading-relaxed">
                ...
                <div className="p-6 bg-white border border-gray-200 rounded-lg">
                  <h4 className="text-lg font-semibold text-ocean mb-3">Scheduling & Automation</h4>
                  <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-green-50 p-6 rounded-lg border-l-4 border-emerald-500">
              <h3 className="text-xl font-bold text-warm-dark mb-3">Installation is Professional</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-warm-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-warm-dark mb-4 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <h3 className="text-xl font-bold text-ocean mb-3">Motorized Blinds</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <h3 className="text-xl font-bold text-ocean mb-3">Motorized Shades</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <h3 className="text-xl font-bold text-ocean mb-3">Motorized Shutters</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start bg-blue-50 p-6 rounded-lg">
              <CheckCircle className="w-6 h-6 text-ocean flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Alexa & Amazon Echo</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4 items-start bg-blue-50 p-6 rounded-lg">
              <CheckCircle className="w-6 h-6 text-ocean flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Google Home & Google Assistant</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4 items-start bg-blue-50 p-6 rounded-lg">
              <CheckCircle className="w-6 h-6 text-ocean flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Smartphone Apps</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4 items-start bg-blue-50 p-6 rounded-lg">
              <CheckCircle className="w-6 h-6 text-ocean flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Circadian Rhythm Scheduling</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4 items-start bg-blue-50 p-6 rounded-lg">
              <CheckCircle className="w-6 h-6 text-ocean flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Weather Integration</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4 items-start bg-blue-50 p-6 rounded-lg">
              <CheckCircle className="w-6 h-6 text-ocean flex-shrink-0 mt-1" />
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Multi-Room Control</h3>
                <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-warm-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12">
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Zap className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">Lower Energy Bills</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Shield className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">Extended Furniture & Décor Life</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Volume2 className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">Improved Sleep & Wellbeing</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Lock className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">Home Security & Presence</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Home className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">Enhanced Property Appeal</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              <Zap className="w-8 h-8 text-ocean mb-4" />
              <h3 className="text-xl font-bold text-warm-dark mb-3">The Comfort Factor</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-warm-dark mb-12 text-center">
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              <details
                key={idx}
                className="bg-warm-white border border-gray-200 rounded-lg p-6 cursor-pointer group"
              >
                <summary className="flex items-start gap-4 font-semibold text-warm-dark hover:text-ocean transition-colors">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="flex gap-4">
              <div className="flex-shrink-0">
                <div className="flex items-center justify-center h-10 w-10 rounded-full bg-ocean text-white font-bold">
                  1
                </div>
              </div>
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Week 1: Consultation & Selection</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Week 2: Order & Coordination</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Week 3-4: Installation</h3>
                <p className="text-gray-700 leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-warm-dark mb-2">Ongoing Support</h3>
                <p className="text-gray-700 leading-relaxed">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-ocean">
              <h3 className="text-lg font-bold text-warm-dark mb-3">Manufacturer Warranty</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-ocean">
              <h3 className="text-lg font-bold text-warm-dark mb-3">Installation Warranty</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-ocean">
              <h3 className="text-lg font-bold text-warm-dark mb-3">Service & Maintenance</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-ocean">
              <h3 className="text-lg font-bold text-warm-dark mb-3">Emergency Support</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-ocean">
              <h3 className="text-lg font-bold text-warm-dark mb-3">Parts Availability</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-ocean">
              <h3 className="text-lg font-bold text-warm-dark mb-3">BBB A+ Rated</h3>
              <p className="text-gray-700 leading-relaxed">
      ...
      {/* CTA FOOTER SECTION */}
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-ocean text-white">
        <div className="max-w-4xl mx-auto text-center">
