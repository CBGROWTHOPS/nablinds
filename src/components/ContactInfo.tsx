      ...
      <div className="space-y-4 sm:space-y-6 mb-8 sm:mb-12">
        ...
        >
          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-ocean bg-opacity-10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-ocean group-hover:bg-opacity-100 transition-colors">
            <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-ocean group-hover:text-white" />
          </div>
          <div>
            <p className="font-semibold text-warm-dark mb-1 text-sm sm:text-base">Phone</p>
            <p className="text-ocean text-lg sm:text-xl font-semibold">954-629-1373</p>
        ...
        >
          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-ocean bg-opacity-10 rounded-full flex items-center justify-center flex-shrink-0 group-hover:bg-ocean group-hover:bg-opacity-100 transition-colors">
            <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-ocean group-hover:text-white" />
          </div>
          <div>
        ...
        <div className="flex items-start gap-3 sm:gap-4 p-5 sm:p-6 bg-soft-sand rounded-xl">
          <div className="w-12 h-12 sm:w-14 sm:h-14 bg-ocean bg-opacity-10 rounded-full flex items-center justify-center flex-shrink-0">
